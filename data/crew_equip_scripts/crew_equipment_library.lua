...
--[[
Can't be in lwl as it adds a tab.
...
---Optional fields: onCreate, onTick, onEquip, onRemove, onPersist, onLoad, sellValue, secret.
---@param itemDef table
function cel.insertItemDefinition(itemDef)
    table.insert(mEquipmentGenerationTable, buildBlueprintFromDefinition(itemDef))
end

---returns the first found lwui.InventoryButton with the given name item
---@param crewId number
...
---Call when you have values that you need to save in your item's custom onPersist()
